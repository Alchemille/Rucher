...
class EventForm(FlaskForm):
    ...
    ruche = IntegerField("Ruche (laisser vide si l'évènement s'applique a toutes les ruches)",
                         validators=[check_ruche_exists_allowed, check_object_defined, check_ruche_rucher_consistent,
...
class RegistrationForm(FlaskForm):
    ...
    email = StringField("Email",
                        validators=[DataRequired(), Email(message='Pas une adresse mail'), check_email_not_used])
    password = PasswordField('Mot de passe', validators=[DataRequired(), EqualTo('pass_confirm',
